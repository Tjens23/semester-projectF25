...
public class ShopServiceImpl implements ShopService {
    ...
    public ShopServiceImpl() {
        ...
        // TODO: Missing proper Item constructor 
        /*items.put("Sword", new Item(0,"Sword", Item.itemType.WEAPON,500));
        items.put("Shield", new Item(1,"Shield", Item.itemTypes.EQUIPMENT,300));
        items.put("Potion", new Item(2, "Potion", Item.itemTypes.AMMO,100));*/
    }
